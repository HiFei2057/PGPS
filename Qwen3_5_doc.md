...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/configuration_qwen3_5.py#L145)
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/configuration_qwen3_5.py#L118)
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/configuration_qwen3_5.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/modeling_qwen3_5.py#L995)

forwardtransformers.Qwen3_5VisionModel.forwardhttps://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/modeling_qwen3_5.py#L1133[{"name": "hidden_states", "val": ": Tensor"}, {"name": "grid_thw", "val": ": Tensor"}, {"name": "**kwargs", "val": ""}]- **hidden_states** (`torch.Tensor` of shape `(seq_len, hidden_size)`) --
...
elements depending on the configuration ([Qwen3_5Config](/docs/transformers/main/en/model_doc/qwen3_5#transformers.Qwen3_5Config)) and inputs.
The [Qwen3_5TextModel](/docs/transformers/main/en/model_doc/qwen3_5#transformers.Qwen3_5TextModel) forward method, overrides the `__call__` special method.
...
`[BaseModelOutputWithPast](/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast) or `tuple(torch.FloatTensor)``
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/modeling_qwen3_5.py#L1308)
...
- **mm_token_type_ids** (`torch.IntTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  ...
  Multimodal token type ids can be obtained using [AutoProcessor](/docs/transformers/main/en/model_doc/auto#transformers.AutoProcessor). See [ProcessorMixin.__call__()](/docs/transformers/main/en/model_doc/align#transformers.AlignProcessor.__call__) for details.0`Qwen3_5ModelOutputWithPast` or `tuple(torch.FloatTensor)`A `Qwen3_5ModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
The [Qwen3_5Model](/docs/transformers/main/en/model_doc/qwen3_5#transformers.Qwen3_5Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/modeling_qwen3_5.py#L1690)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Qwen3_5Config](/docs/transformers/main/en/model_doc/qwen3_5#transformers.Qwen3_5Config)) and inputs.
The [Qwen3_5ForCausalLM](/docs/transformers/main/en/model_doc/qwen3_5#transformers.Qwen3_5ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen3_5/tokenization_qwen3_5.py#L28)
